...
cv::Mat System::process(const Frame &inputFrame) {
  ...
  if((void*) &inputFrame != (void*) &_14938569046430841631 ) {
    swap (_4913157516830781457,_14938569046430841631 );
    _14938569046430841631 = inputFrame;
  }

  if(_17450466964482625197 == MODE_SLAM && !_2869602498954317713->hasMap ())
    _2869602498954317713 -> setParams (_9098980761384425343,_14938569619851839146.enableLoopClosure);
    ...
    for(auto &_175247760135:_4913157516830781457.ids)
      if(_175247760135 != std::numeric_limits <uint32_t>::max()){
        if(!_9098980761384425343->map_points.is(_175247760135))
          _175247760135 =std::numeric_limits <uint32_t >::max ();
        else if(_9098980761384425343 -> map_points [_175247760135 ].isBad())
          _175247760135 =std::numeric_limits <uint32_t > ::max ();
        }

    if(_9098980761384425343 -> isEmpty ()  &&  _17450466964482625197 ==  MODE_SLAM )  {
      if (_2016327979059285019 ( _14938569046430841631 ))
        _3857178690860967008 = STATE_TRACKING ;
    } else {
      if(_3857178690860967008 == STATE_TRACKING ) {
        _10576739190144361304 = _1513765969352381626 (_4913157516830781457,_17976495724303689842 );
        // bug here
        _17976495724303689842 = _11166622111371682966 ( _14938569046430841631,_17976495724303689842 );
  ...
  _1403653089436386197 = std::thread ([&]() {
    if( _2869602498954317713 -> mapUpdate() ) {
      if(_2869602498954317713 -> bigChange ()){
        _14938569046430841631.pose_f2g = _2869602498954317713 -> getLastAddedKFPose ();
        _17976495724303689842 = _2869602498954317713 -> getLastAddedKFPose ();
      }
    };
  });
  if(_46082575014988268.empty () && _1705635550657133790.empty ())
    _3944249282595574931 -> process ( _6441194614667703750,_18212413899834346676,_14938569046430841631,_9933887380370137445 );
  else if(_1705635550657133790.empty ())
    _3944249282595574931 -> process_rgbd ( _6441194614667703750,_46082575014988268,_18212413899834346676,_14938569046430841631,_9933887380370137445 );
  else
    _3944249282595574931 -> processStereo ( _6441194614667703750,_1705635550657133790,_18212413899834346676,_14938569046430841631,_9933887380370137445 );
...
_9098980761384425343 ->
 ...
 auto _3005399795337363304:_4240713669852012646 )
  ...
  &inputFrame:_9098980761384425343 ->
...
-1 ;
  ...
  if(_175247759380 < _9098980761384425343->map_points.data_size() || _9098980761384425343->map_points[_175247759380].isBad()) 
...
se3 System::_11166622111371682966 (Frame &_16940374161810747371,se3 _14387478432460351890 ) {
  std::vector < cv :: DMatch > _637068542992099399 ;
  se3 _5769551021164122736 = _14387478432460351890 ;

  if ( _9098980761384425343 ->map_points.size () > 0 ){
    if(!_14463320619150402643.empty ())
      _5769551021164122736 = _14463320619150402643*_5769551021164122736.convert ();

    _16940374161810747371.pose_f2g = _5769551021164122736;
    _637068542992099399 = _11946837405316294395 ( _16940374161810747371,_4913157516830781457,_14938569619851839146.maxDescDistance*1.5,_14938569619851839146.projDistThr );

    int _9870110657242862171 = 0 ;

    if ( _637068542992099399.size () > 30 ){
      auto _14671559813105454070 = _5769551021164122736 ;
      _9870110657242862171 = PnPSolver :: solvePnp ( _16940374161810747371,_9098980761384425343,_637068542992099399,_14671559813105454070,_10576739190144361304 );
      
      if (_9870110657242862171 > 30) _5769551021164122736 = _14671559813105454070 ;
    
    }
    else {
      FrameMatcher _16997326787393468537 ( FrameMatcher :: TYPE_FLANN ) ;
      _16997326787393468537.setParams ( _9098980761384425343 -> keyframes [ _10576739190144361304 ], FrameMatcher :: MODE_ASSIGNED,_14938569619851839146.maxDescDistance*2,0.6,true,3 ) ;
      _637068542992099399 = _16997326787393468537.match (_16940374161810747371,FrameMatcher :: MODE_ALL );

      if( _637068542992099399.size () > 30 ) {
        for( auto &_2654435878:_637068542992099399 )
          _2654435878.trainIdx = _9098980761384425343 -> keyframes [ _10576739190144361304 ].ids [_2654435878.trainIdx ];
    ...
    if ( _9870110657242862171 > 30 ) {
      ...
      for( auto _2654435878: _637068542992099399 ) {
        _9098980761384425343->map_points[_2654435878.trainIdx ].lastFIdxSeen = _16940374161810747371.fseq_idx ;
        _9098980761384425343->map_points[_2654435878.trainIdx ].setVisible();
      }
    } else {
    ...
    auto _3521005873836563963 = _9098980761384425343 -> matchFrameToMapPoints (
      _9098980761384425343 -> TheKpGraph.getNeighborsVLevel2 ( _10576739190144361304,true ),
      _16940374161810747371, _5769551021164122736 ,_14938569619851839146.maxDescDistance*2, _3763415994652820314,true );

    _637068542992099399.insert ( _637068542992099399.end (),_3521005873836563963.begin (),_3521005873836563963.end ()  );

    filter_ambiguous_query (_637068542992099399 ) ;

  }

  int _8650310500205049352 = PnPSolver ::solvePnp ( _16940374161810747371,_9098980761384425343,_637068542992099399,_5769551021164122736,_10576739190144361304 );
  bool _6535949166237672095 = false ;

  if (_16940374161810747371.markers.size ()>0 ){
    int _9870110666330890270 = 0 ;

    for( size_t _2654435874 =  0 ; _2654435874 <  _16940374161810747371.markers.size () ; _2654435874 ++ ) {
      auto _11093822290813 = _9098980761384425343 -> map_markers.find (_16940374161810747371.markers [ _2654435874 ] .id );

      if( _11093822290813 ==     _9098980761384425343 ->  map_markers.end () )
        continue ;
      ...
      if ( _16940374161810747371.markers [  _2654435874 ] .poses.err_ratio < _14938569619851839146.aruco_minerrratio_valid )
        continue ;
  ...
  for( size_t _2654435874 =   0 ;_2654435874 < _637068542992099399.size () ;_2654435874 ++) {
    _9098980761384425343 -> map_points [_637068542992099399 [ _2654435874 ].trainIdx ].setSeen ();

    _16940374161810747371.ids [ _637068542992099399 [ _2654435874 ].queryIdx ] = _637068542992099399 [_2654435874 ] .trainIdx ;

    if (_637068542992099399 [_2654435874 ] .imgIdx == -1 )
      _16940374161810747371.flags [ _637068542992099399 [_2654435874 ].queryIdx ].set (Frame :: FLAG_OUTLIER,true );
  }

  return _5769551021164122736 ;
}
