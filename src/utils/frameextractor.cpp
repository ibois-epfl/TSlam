...
_8033463663468506753 )
 ...
 void FrameExtractor ::
  ...
  &_3005401535270843804, ImageParams &_4702029808027735906 , Frame &frame_460825, uint32_t
...
_12800511165451773841 [
 ...
 ;
    ...
    getMatches ( 
      _6807036698572949990, frame_460825, _988585933247351277, _706246338686106, _15583426435822513722, 0 )
   ;
...
0 ]
      ...
      ,
            _11093822296219,frame_460825.scaleFactors,_3005399809928654743 )
      ;
...
DMatch >
      & _6807036698572949990, const Frame &frame_460825, const std ::
...
_1522768718325991990 = 16 ;
 ...
 frame_460825.desc,_175247759447,_6807141016749312283,_16988745808691518194 ,xflann :: KnnSearchParams (     _1522768718325991990,false )
  )
        ;
...
_706246330899664 =        frame_460825.und_kpts [
...
2,0 )
   ...
   _706246330899667 = frame_460825.und_kpts [
 ...
 ;
   ...
   _706246330899666 = frame_460825.und_kpts [
...
getDescDistance ( 
        frame_460825.desc,_16937466872311873851,_15583426435822513722,_16997329059161965027 )
  ;
...
-1 )
 {
  ...
  ( 
 _12031385974440167876 ==         frame_460825.und_kpts [
...
.octave &&
 ...
 processStereo ( 
   const cv ::
       Mat &_16937270569698259356, const cv :: Mat &_1705492249324718059, const ImageParams &_175247760147, Frame &frame_460825, uint32_t frameseq_idx )
 {
...
MapPoint ::
 ...
 getDescDistance ( 
frame_460825.desc,_2654435874,_1534768455952794120,_5555178974982484866 )
    ;
...
FrameExtractor ::
 ...
 Mat &_46082544231248938, const cv ::
        ...
        Mat &_14382598117525421800,const ImageParams &_175247760147,Frame &frame_460825, uint32_t frameseq_idx ) {
...
_12800511165451773841 [
  ...
  ;
    ...
    frame_460825.depth.resize (     frame_460825.und_kpts.size ()
 ) ;

     for( 
   size_t _2654435874 =         0 ;

 _2654435874 < frame_460825.depth.size () ;
...
void FrameExtractor::process (const cv::Mat &_46082544231248938, const ImageParams &_175247760147,Frame &frame_460825, uint32_t frameseq_idx ) {
  _14329080428242784455 ( _13116459431724108758.kptImageScaleFactor, _46082544231248938,_175247760147 ) ;
  extractFrame ( _12800511165451773841[0], frame_460825, frameseq_idx ); // bug here (next)
}
...
void FrameExtractor :: extractFrame ( const ImgInfo &Iinfo, Frame &frame_460825, uint32_t frameseq_idx ) {
  frame_460825.clear();

  vector<cv::KeyPoint> _9811310495564694013 ;

  std::thread _15593584088352382451([&]{
    if( _4309197024622458338 ) {
      _8033463663468506753->detectAndCompute (_12800511165451773841[0]._8358128829407646415, cv::Mat () ,_9811310495564694013,frame_460825.desc,_10675870925382111478 );
      frame_460825.KpDescType =   _8033463663468506753->getDescriptorType();
    }
  });

  std::thread _5221495899814560498 ([&]{
...
auto &_2654435868:_8214686538440707422.corners )
   {
                    ...
                    _2654435868.x *=     Iinfo._6972553715263421613.first ;

                    _2654435868.y *=    Iinfo._6972553715263421613.second ;

                 }

                frame_460825.markers.push_back ( 
_8214686538440707422 )
   ...
   ;
    ...
    _5221495899814560498.join(); // bug here

  if(debug :: Debug :: getLevel () >=  100 || _13116459431724108758.saveImageInMap ){
    std :: vector < uchar >     _11093821971029 ;
    cv :: imencode ( "\x2e\x6a\x70\x67",Iinfo._15530082771795719302,_11093821971029, { cv :: IMWRITE_JPEG_QUALITY,90 });
  ...
  double _175247759750 =       _8033463663468506753 -> getParams ()  .scaleFactor ;

  frame_460825.scaleFactors [ 0 ]   =  1 ;
  
  for( size_t _2654435874 = 1 ; _2654435874 < frame_460825.scaleFactors.size () ;  _2654435874 ++ )
    frame_460825.scaleFactors [ _2654435874 ]  =  frame_460825.scaleFactors [ _2654435874-1 ] *_175247759750 ;
...
._5505640830793117477.undistortPoints ( 
 _11093822294365 )
     ;
        ...
        frame_460825.und_kpts =       _9811310495564694013 ;

        frame_460825.kpts.resize ( 
 _9811310495564694013.size ()
 )
       ;
...
.pt ;
            ...
            frame_460825.und_kpts [ _2654435874 ]
 ...
 .pt =    _11093822294365 [
  ...
  _markerObservation.und_corners )      ;
    ...
    frame_460825.flags.resize ( 
    frame_460825.und_kpts.size ()  )
 ;

     for( 
 auto &_2654435887:frame_460825.flags )
   _2654435887.reset ()
      ;

    frame_460825.ids.resize ( 
    frame_460825.und_kpts.size ()
      )
  ;
 ...
 ::
   ...
   ;
     ...
     for( 
 auto &_11093822405034:frame_460825.ids )
  _11093822405034 =    _706246332827243 ;

    frame_460825.idx =      std ::
  ...
  max ()
    ...
    frame_460825.fseq_idx =       frameseq_idx ;

    frame_460825.imageParams =       _12800511165451773841 [
 0 ]

      ._5505640830793117477 ;

    frame_460825.create_kdtree () ;

    frame_460825.minXY =        cv ::
      Point2f ( 
   0,0 )
 ;

    frame_460825.maxXY =   cv ::

Point2f ( frame_460825.imageParams.CamSize.width,frame_460825.imageParams.CamSize.height )     ;

     if(  frame_460825.imageParams.Distorsion.total () !=  0 )
    {
...
cv ::
   ...
   frame_460825.minXY,frame_460825.maxXY }
     ;

        frame_460825.imageParams.undistortPoints (    _6806985041881495917 )
  ;

        frame_460825.minXY = _6806985041881495917 [

0 ]
   ;

        frame_460825.maxXY =   _6806985041881495917 [ 1 ]
