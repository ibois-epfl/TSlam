...
void Params::toStream(ostream &str)const{
    ...
    str.write((char*)&minFocalLength,sizeof(minFocalLength));
    str.write((char*)&featuresFirstLevel,sizeof(featuresFirstLevel));
    str.write((char*)&featuresFactor,sizeof(featuresFactor));
    str.write((char*)&maxOctave,sizeof(maxOctave));
    str.write((char*)&nKFMatcher,sizeof(nKFMatcher));
...
void Params::fromStream(istream &str){
    ...
    str.read((char*)&minFocalLength,sizeof(minFocalLength));
    str.read((char*)&featuresFirstLevel,sizeof(featuresFirstLevel));
    str.read((char*)&featuresFactor,sizeof(featuresFactor));
    str.read((char*)&maxOctave,sizeof(maxOctave));
    str.read((char*)&nKFMatcher,sizeof(nKFMatcher));
...
void Params::saveToYMLFile(const string &path){
    ...
    fs<<"minFocalLength" <<minFocalLength;
    fs<<"featuresFirstLevel" <<featuresFirstLevel;
    fs<<"featuresFactor" <<featuresFactor;
    fs<<"nKFMatcher" <<nKFMatcher;
...
std::cout <<"Params:"<< filePath<< std::endl;
    //first
    ...
    attemtpRead("minFocalLength",minFocalLength,fs);
    attemtpRead("featuresFirstLevel",featuresFirstLevel,fs);
    attemtpRead("featuresFactor",featuresFactor,fs);
    attemtpRead("nKFMatcher",nKFMatcher,fs);
